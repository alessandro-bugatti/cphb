\documentclass[twoside,12pt,a4paper,italian]{book}
...
\author{\Large Antti Laaksonen\\[1ex] 
\small Alessandro Bugatti (Translator)}
...
%\Added to avoid footnode splitting on different pages
